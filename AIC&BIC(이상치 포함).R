...
# Backward AIC : y=5+0.381*Study_Hours_Per_Day-0.019*Extracurricular_Hours_Per_Day-0.052*Stress_Level_Moderate1 
...
# Backward BIC : y=4.9104+0.385*Study_Hours_Per_Day
lm_result=lm(Grades~Study_Hours_Per_Day+Extracurricular_Hours_Per_Day+Sleep_Hours_Per_Day+Social_Hours_Per_Day+Physical_Activity_Hours_Per_Day+Gender_Male+Stress_Level_Low+Stress_Level_Moderate,data=lifestyle) 
step(lm_result,direction='backward',k=log(n))


# Forward AIC : y=5+0.381*Study_Hours_Per_Day-0.052*Stress_Level_Moderate1-0.019*Extracurricular_Hours_Per_Day
...
# Forward BIC : y=4.910+0.385*Study_Hours_Per_Day
lm_result=lm(Grades~1,data=lifestyle)
